...
const String newsAPIKey = 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx';
const String newsAPIEndPoint = '/top-headlines';
// const String newsAPIQuery = 'q=farmers&sortBy=popularity';

const String weatherAPIKey = 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx';
const String weatherAPIBaseURL = 'https://api.weatherapi.com/v1';
const String weatherAPIEndPoint = '/current.json';
